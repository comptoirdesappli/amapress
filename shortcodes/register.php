	...
	amapress_register_shortcode( 'inscription-distrib', 'amapress_inscription_distrib_shortcode',
		[
			...
			'args' => [
				...
				'max_dates'                 => '(Par défaut “-1”) Nombre maximum de distributions à venir à afficher',
				'lieu'                      => 'Filtre de lieu',
				'column_date_width'         => '(Par défaut 6rem) Largeur de la colonne Dates/Produits',
				'fixed_column_width'        => '(Par défaut, 8rem) : fixe la largeur des colonnes Responsables ; en em ou px pour forcer une largeur fixe ; % pour répartir la largeur de colonnes sur la largeur du tableau',
				'scroll_y'                  => '(en px, 300 par défaut) Limite la hauteur à X pixels et permet la navigation verticale avec scroll dans la date de distributions',
				'font_size'                 => '(par défaut 11px) Taille relative du texte dans la vue en % ou em ou rem',
				'show_no_contrat'           => '(Par défaut “true”) Afficher un message "Pas de livraison" pour les dates sans livraison pour l\'amapien',
				'show_contrats_desc'        => '(Par défaut “true”) Afficher la liste des contrats pour chaque date ; si entier, limite le nombre de lignes affichées à ce nombre',
				'show_contrats_count'       => '(Par défaut “false”) Afficher le nombre de contrats pour chaque date',
