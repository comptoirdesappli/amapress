...
require_once( TF_PATH . 'lib/class-entity.php' );
require_once( TF_PATH . 'lib/class-user-entity.php' );
require_once( TF_PATH . 'lib/class-option.php' );
//require_once( TF_PATH . 'lib/class-option-show-posts.php');
//require_once( TF_PATH . 'lib/class-option-show-users.php');
require_once( TF_PATH . 'lib/class-option-related-posts.php' );
require_once( TF_PATH . 'lib/class-option-related-users.php' );
require_once( TF_PATH . 'lib/class-option-action-buttons.php' );
require_once( TF_PATH . 'lib/class-option-ajax-button.php' );
require_once( TF_PATH . 'lib/class-option-address.php' );
...
require_once( TF_PATH . 'lib/class-option-multicheck-users.php' );
require_once( TF_PATH . 'lib/class-option-note.php' );
require_once( TF_PATH . 'lib/class-option-number.php' );
require_once( TF_PATH . 'lib/class-option-float.php' );
require_once( TF_PATH . 'lib/class-option-price.php' );
...
require_once( TF_PATH . 'lib/class-option-readonly.php' );
...
require_once( TF_PATH . 'lib/class-option-select-page-templates.php' );
