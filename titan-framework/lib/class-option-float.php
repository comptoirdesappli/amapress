 ...
 * @since    1.0
 **/
class TitanFrameworkOptionFloat extends TitanFrameworkOption {
	...
	public function display() {
		...
		printf( '<input class="%s-text" name="%s" placeholder="%s" id="%s" type="number" value="%s"/> %s <p class="description">%s</p>',
			$this->settings['size'],
			$this->getID(),
	...
	public function registerCustomizerControl( $wp_customize, $section, $priority = 1 ) {
		$wp_customize->add_control( new TitanFrameworkOptionFloatControl( $wp_customize, $this->getID(), array(
 ...
 */
add_action( 'customize_register', 'registerTitanFrameworkOptionFloatControl', 1 );
 ...
 * @since    1.0
 */
function registerTitanFrameworkOptionFloatControl() {
	class TitanFrameworkOptionFloatControl extends WP_Customize_Control {
		public $description;
		public $size;
		public $unit;
		public $required;
