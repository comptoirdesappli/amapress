...
class TitanFrameworkCustomizer {
	...
	private $defaultSettings = array(
		...
		'panel_desc' => '',
		// The description to display on the panel
		'panel_id'   => '',
		// The panel ID to create / add to. If this is blank & `panel` is given, this will be generated
	...
	function __construct( $settings, $owner ) {
		...
		if ( isset( $wp_customize ) ) {
			tf_add_filter_once( 'tf_pre_get_value_' . $this->owner->optionNamespace, array(
				$this,
				'useCustomizerModifiedValue'
			), 10, 3 );
		}
	}
