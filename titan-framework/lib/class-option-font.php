...
class TitanFrameworkOptionFont extends TitanFrameworkOption {
	...
	function __construct( $settings, $owner ) {
		...
		tf_add_filter_once( 'tf_generate_customizer_preview_css_' . $this->getOptionNamespace(), array(
			$this,
			'generateCustomizerPreviewCSS'
		) );
	...
	public function getGoogleFontURLs() {
		...
		$subsets = apply_filters( 'tf_google_font_subsets_' . $this->getOptionNamespace(), array(
			'latin',
			'latin-ext'
		) );
	...
	public function display() {
        ...
        <div>
            ...
            <label <?php echo $visibilityAttrs ?>>
                Color
                <input class='tf-font-sel-color' type="text" value="<?php echo esc_attr( $value['color'] ) ?>"
            ...
            <label style='display: none'>
                Shadow Color
                <input class="tf-font-sel-shadow-color" type="text"
                       value="<?php echo esc_attr( $value['text-shadow-color'] ) ?>"
                       data-default-color="<?php echo esc_attr( $value['text-shadow-color'] ) ?>"/>
            </label>
            <label style='display: none'>
                Shadow Opacity
        ...
        <div <?php echo $visibilityAttrs ?>>
            ...
            <input type='hidden' class='tf-font-sel-dark'
                   value='<?php echo esc_attr( $value['dark'] ? 'dark' : '' ) ?>'/>
        </div>
		<?php
	...
	class TitanFrameworkOptionFontControl extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <div class='tf-font'>
				...
				?>
                <input type='hidden' class='tf-for-saving' <?php $this->link() ?>
