...
class TitanFrameworkOptionEnable extends TitanFrameworkOption {
	...
	public function display() {
        ...
        <span class="button button-<?php echo checked( $this->getValue(), 1, false ) ? 'primary' : 'secondary' ?>"><?php echo $this->settings['enabled'] ?></span>
        <span class="button button-<?php echo checked( $this->getValue(), 1, false ) ? 'secondary' : 'primary' ?>"><?php echo $this->settings['disabled'] ?></span>
		<?php
	...
	class TitanFrameworkOptionEnableControl extends WP_Customize_Control {
		...
		public function render_content() {
            ...
            <div class='tf-enable'>
                ...
                <span class="button button-<?php echo checked( $this->value(), 1, false ) ? 'primary' : 'secondary' ?>"><?php echo $this->options['enabled'] ?></span><span
