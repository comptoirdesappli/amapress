...
var object =
    {
        ...
        someFunctionWithAVeryLongName: function (firstParameter='something',
                                                 secondParameter='booooo', third=null, fourthParameter=false,
                                                 fifthParameter=123.12, sixthParam=true) /** w00t */ {
        }

        someFunctionWithAVeryLongName2: function (firstParameter='something', secondParameter='booooo', third=null) {
        }

    }

function getInstalledStandards(includeGeneric=false,
                               standardsDir='') {
}
