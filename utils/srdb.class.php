...
if ( ! class_exists( 'amps_icit_srdb' ) ) {
	class amps_icit_srdb {
		...
		public function __construct( $args ) {
			...
			foreach ( array( 'exclude_cols', 'include_cols', 'tables', 'exclude_tables' ) as $maybe_string_arg ) {
				...
				ini_set( 'unserialize_callback_func', 'icit_object_serializer' );
...
if ( ! function_exists( 'icit_object_serializer' ) ) {
	/**
	 * .. make classes
	 *
	 ...
	 * @return void
	 */
	function icit_object_serializer( $class_name ) {
