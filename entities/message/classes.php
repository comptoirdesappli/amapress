...
class AmapressMessage extends TitanEntity {
	...
	public function getTarget_name() {
		return $this->getCustom( 'amapress_message_target_name' );
	}

	public function getQuery_string() {
		return $this->getCustom( 'amapress_message_query_string' );
	}

	public function getTarget_type() {
		return $this->getCustom( 'amapress_message_target_type' );
	}
	...
	public function getContent_for_sms() {
		return $this->getCustom( 'amapress_message_content_for_sms' );
	}
