...
class Amapress_EventBase extends TitanEntity {
	...
	public function getProperty( $name ) {
		switch ( $name ) {
			case 'evenement':
				return esc_html( $this->getTitle() );
			case 'lien-evenement':
				return Amapress::makeLink( $this->getPermalink() );
			case 'lien-evenement-ical':
				return add_query_arg( 'events_id', $this->ID, Amapress_Agenda_ICAL_Export::get_link_href() );
			case 'lieu-info':
				return $this->getLieuInformation();
			case 'horaires-evenement':
				return date_i18n( 'D j M Y', $this->getStartDateAndHour() ) .
				       ' de ' . date_i18n( 'H:i', $this->getStartDateAndHour() ) .
				       ' à ' . date_i18n( 'H:i', $this->getEndDateAndHour() );
		}
