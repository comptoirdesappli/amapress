...
class Amapress_Users_List_Table extends WP_List_Table {
	private $items_per_page_option_name;

	function __construct( $singular, $plural, $items_per_page_option_name ) {
		global $status, $page;
		$this->items_per_page_option_name = $items_per_page_option_name;
	...
	function prepare_items() {
		...
		$users_per_page = $this->get_items_per_page( $this->items_per_page_option_name );
