...
require_once( AMAPRESS__PLUGIN_DIR . 'entities/user_commande/classes.php' );
...
require_once( AMAPRESS__PLUGIN_DIR . 'entities/commande/classes.php' );
...
require_once( AMAPRESS__PLUGIN_DIR . 'entities/user_commande/custom.content.php' );
require_once( AMAPRESS__PLUGIN_DIR . 'entities/adhesion_paiement/custom.content.php' );
require_once( AMAPRESS__PLUGIN_DIR . 'entities/commande/custom.content.php' );
...
require_once( AMAPRESS__PLUGIN_DIR . 'entities/user_commande/register.php' );
...
require_once( AMAPRESS__PLUGIN_DIR . 'entities/commande/register.php' );
