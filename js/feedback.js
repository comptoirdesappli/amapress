...
(function (window, document, undefined) {
    ...
    window.Feedback = function (options) {
        ...
        options.action = options.action || 'send_feedback';

        options.context = options.context || {};
        options.context.location = window.location.href;
        options.context.navigator = {};
        for (var p in window.navigator) {
            options.context.navigator[p] = navigator[p];
        }
        var w = window,
            d = document,
            e = d.documentElement,
        ...
        options.context.viewport = x + 'x' + y;
        ...
        var button,
            ...
            returnMethods = {
                ...
                close: function () {
                    ...
                    removeElements(Array.prototype.slice.call(document.getElementsByClassName('feedback-blackedout'), 0));
                    removeElements(Array.prototype.slice.call(document.getElementsByClassName('feedback-highlighted'), 0));
                ...
                send: function (adapter) {
                    ...
                    var request_data = {};
                    request_data.action = options.action;
                    request_data.context = options.context;
                    ...
                    adapter.send(request_data, function (success) {
    ...
    window.Feedback.Form = function (elements) {
        ...
        this.elements = elements || [{
            type: "textarea",
            name: "Problème",
            label: "Merci de décrire le problème que vous rencontrez",
            required: false
        }];
            ...
            var script,
                ...
                runH2c = function () {
                    try {
                        ...
                        window.html2canvas(document.body, options).then(options.onrendered);
